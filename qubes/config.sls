...
# Qubes Configuration
#
# 1. Sets formula file_roots and updates salt configuration setting in
#    /etc/salt/minion.s/f_defaults based on pillar data located in 
#    /srv/pillar/base/qubes/config.sls.
#
# 2. Ensures salt-minion service is dead
#
# Execute:
#   qubesctl state.sls qubes.config
##

{% from "qubes/map.jinja" import salt_settings with context %}
